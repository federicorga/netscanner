    ...
    mostrarListaDePuertos = () => {// Muestra los puertos por defecto y los personalizados
        ...
        const knownPortsServices = [ // Array de objetos con puertos y servicios asociados se utiliza para evaluar si ese puerto es conocido o no.
            ...
            { port: 194, name: 'IRC' },
            { port: 389, name: 'LDAP estándar (sin cifrado)' },
            { port: 443, name: 'HTTPS' },
            { port: 445, name: 'SMB (Server Message Block)/CIFS (Common Internet File System)' },
            { port: 465, name: 'SMTPS' },
            ...
            { port: 636, name: 'LDAPS (SSL/TLS seguro)' },
            { port: 993, name: 'IMAPS' },
            { port: 995, name: 'POP3S' },
            ...
            { port: 5900, name: 'VNC' },
            {port:5985, name: 'WinRM - Windows Remote Management'},
            {port: 5986, name: 'WinRM - Windows Remote Managment (SSL)'},
